...
public class ClientService {
    ...
    public Client createClient(UUID agentId,Client client){
        //find the agent under this client
        Agent agent=agentRepository.findById(agentId)
                .orElseThrow(()->new RuntimeException("Agent not found with this id:"+agentId));
